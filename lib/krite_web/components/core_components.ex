defmodule KriteWeb.CoreComponents do
  @moduledoc """
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          ...
          "border-nat-500 focus:border-blue-500",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(KriteWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(KriteWeb.Gettext, "errors", msg, opts)
    end
  end
